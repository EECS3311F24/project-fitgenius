...
- RPM.md (Release Planning Meetings) (max 3 marks)
  ...
  Your Mark: 1 (No release plan meeting documentation and no user stories for release.)
...
- Software Architecture Diagram (max 4 marks)
  ...
  Your Mark: 2 (Not sure which architecture followed from the diagram. Only React
   component diagram given. Also, no database dependency shown. Database should
  be necessary given that many user stories include personalization features.)

Total mark on System Design: 8/10
...
- Presentation (max 2 marks)
  ...
  Your Mark: 1 (Improve color scheme. Light colored font on light colored 
  background is hard to see. Also, do better positioning of different
  items on the page.)
