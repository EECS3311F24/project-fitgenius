...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 9 / 10 (Blocker term is used to indicate component withing
  the project that may block the development or usability of another feature. Your lack
  of availability due to courseload is actually part of your capacity and not blocker
...
## Tracking on Trello  (max 24 marks) 
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 2 (1 member with no commit/contribution in any PR.)
  ...
  - Branch Naming (max 2 marks)
    ...
    Your Mark: 1 (`brandonngithub-save-created-plans-in-database` branch have no 
user story or ticket number)
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 2 (Architecture diagram is not formatted well. And a high-level 
architecture diagram does not need that much detail i.e., name of every component.)
...
## Documentation (max 1 mark)
  ...
  Your Mark: 0 / 1 (No documentation file found.)
...
## Sprint Demo (Max 10 marks) 
  ...
  Your Mark: 9 / 10 (Plan saving not shown in the demo.)
